...
@section('title', 'Edit Drumband')

@section('breadcrumb')
	<li class="breadcrumb-item">Dashboard</li>
	<li class="breadcrumb-item">Drumband</li>
...
@section('content')
   <div class="row">
         <div class="col-md-12">
              <div class="card">
                  <div class="card-body">
                       <div class="card-title">{{ __('Edit Drumband') }}</div>

                        <form method="post" action="{{ url('/dashboard/data-drumband', $edit->id) }}">
                           @csrf
                           @method('put')
                           ...
                           <a href="{{ url('dashboard/data-drumband') }}" class="btn btn-primary btn-rounded">
