...
@section('title', 'Edit Outbond')

@section('breadcrumb')
	<li class="breadcrumb-item">Dashboard</li>
	<li class="breadcrumb-item">Outbond</li>
...
@section('content')
   <div class="row">
         <div class="col-md-12">
              <div class="card">
                  <div class="card-body">
                       <div class="card-title">{{ __('Edit Outbond') }}</div>

                        <form method="post" action="{{ url('/dashboard/data-outbond', $edit->id) }}">
                           @csrf
                           @method('put')
                           ...
                           <a href="{{ url('dashboard/data-outbond') }}" class="btn btn-primary btn-rounded">
