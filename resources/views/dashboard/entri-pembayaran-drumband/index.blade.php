...
@section('title', 'Pembayaran Drumband')

@section('breadcrumb')
    <li class="breadcrumb-item">Dashboard</li>
    <li class="breadcrumb-item active">Pembayaran Drumband</li>
@endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="card-title">Entri Pembayaran Drumband</div>

                    <form method="post" action="{{ url('/dashboard/pembayaran-drumband') }}">
                        @csrf
                        ...
                        <div class="input-group mb-3">
                            ...
                            <select name="id_drumband" class="custom-select @error('id_drumband') is-invalid @enderror"
                                {{ count($drumbands) == 0 ? 'disabled' : '' }}>
                                @if (count($drumbands) == 0)
                                    <option>Pilihan tidak ada</option>
                                @else
                                    @foreach ($drumbands as $value)
                        ...
                        <table class="table">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col">NOMINAL DRUMBAND</th>
