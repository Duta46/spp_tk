...
@section('title', 'Tambah Potab')

@section('breadcrumb')
    <li class="breadcrumb-item">Dashboard</li>
    <li class="breadcrumb-item">Potab</li>
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <div class="card-title">{{ __('Tambah Potab') }}</div>

                    <form method="post" action="{{ url('/dashboard/potab') }}">
                        @csrf
                        ...
                        <div class="border-top">
                            ...
                            <a href="{{ url('/dashboard/potab') }}" class="btn btn-primary btn-rounded mt-3">
