...
@section('content')
   <div class="row">
         <div class="col-md-12">
              <div class="card">
                  <div class="card-body">
                       <div class="card-title">{{ __('Edit Ijazah') }}</div>

                        <form method="post" action="{{ url('/dashboard/data-ijazah', $edit->id) }}">
                           @csrf
                           @method('put')
                           ...
                           <a href="{{ url('/dashboard/ijazah') }}" class="btn btn-primary btn-rounded">
