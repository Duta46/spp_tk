...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">Pembayaran Ijazah</li>
...
@section('content')
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="card-title">Edit Pembayaran Ijazah</div>

                    <form method="post" action="{{ url('/dashboard/pembayaran-ijazah', $edit->id) }}">
                        @csrf
                        @method('put')
                        ...
                        <div class="input-group mb-3">
                            ...
                            <select name="id_ijazah" class="custom-select @error('id_bekal') is-invalid @enderror"
                                {{ count($ijazah) == 0 ? 'disabled' : '' }}>
                                @if (count($ijazah) == 0)
                                ...
                                @else
                                    ...
                                    @foreach ($ijazah as $value)
                                        <option value="{{ $value->id }}"
                                            {{ $edit->id_ijazah == $value->id ? 'selected' : '' }}>
                        ...
                        <a href="{{ url('/dashboard/pembayaran-ijazah') }}" class="btn btn-primary btn-rounded">
