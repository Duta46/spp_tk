...
@section('breadcrumb')
	...
	<li class="breadcrumb-item">Daftar Ulang</li>
...
@section('content')
   <div class="row">
         <div class="col-md-12">
              <div class="card">
                  <div class="card-body">
                       <div class="card-title">{{ __('Edit Daftar Ulang') }}</div>

                        <form method="post" action="{{ url('/dashboard/data-daftar-ulang', $edit->id) }}">
                           @csrf
                           @method('put')
                           ...
                           <a href="{{ url('dashboard/data-daftar-ulang') }}" class="btn btn-primary btn-rounded">
