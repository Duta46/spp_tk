...
@section('title', 'Edit Pembayaran Outbond')

@section('breadcrumb')
    <li class="breadcrumb-item">Dashboard</li>
    <li class="breadcrumb-item">Pembayaran Outbond</li>
...
@section('content')
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="card-title">Edit Pembayaran Outbond</div>

                    <form method="post" action="{{ url('/dashboard/pembayaran-outbond', $edit->id) }}">
                        @csrf
                        @method('put')
