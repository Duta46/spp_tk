...
@section('content')
   ...
   <div class="alert alert-success text-center"><b>Selamat Datang</b> di Aplikasi Pembayaran SPP TK</div>
                              ...
                              @foreach($pembayaran as $history)
                                <div class="d-flex flex-row comment-row">
                                    ...
                                    <hr>
                                        ...
                                        <span class="badge badge-success badge-rounded float-right">{{ $history->created_at->format('M d, Y') }}</span>
