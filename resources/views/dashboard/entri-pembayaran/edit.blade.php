                    ...
                    <form method="post" action="{{ url('dashboard/pembayaran', $edit->id) }}">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <select class="custom-select @error('spp_bulan') is-invalid @enderror" name="spp_bulan">
                                ...
                                <option value="februari" {{ $edit->spp_bulan == 'februari' ? 'selected' : '' }}>Februari
                                </option>
                                ...
                                <option value="agustus" {{ $edit->spp_bulan == 'agustus' ? 'selected' : '' }}>Agustus
                                </option>
                                <option value="september" {{ $edit->spp_bulan == 'september' ? 'selected' : '' }}>September
                                </option>
                                <option value="oktober" {{ $edit->spp_bulan == 'oktober' ? 'selected' : '' }}>Oktober
                                </option>
                                <option value="november" {{ $edit->spp_bulan == 'november' ? 'selected' : '' }}>November
                                </option>
                                <option value="desember" {{ $edit->spp_bulan == 'desember' ? 'selected' : '' }}>Desember
                                </option>
                            </select>
                        </div>
                        <span class="text-danger">
