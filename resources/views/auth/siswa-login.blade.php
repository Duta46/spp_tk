                        ...
                        <div class="card-body p-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="nisn"
                                    ...
                                    placeholder="Masukan NISN" value="{{ old('nisn') }}">
                                @if ($errors->has('email'))
                                    <small class="form-text invalid-feedback"
                                        style="display: block !important">{{ $errors->first('nisn') }}</small>
                                @endif
                            </div>
                            <div class="form-group">
                            ...
                            <div class="alert alert-success m-3">
                                Login untuk <b>Petugas</b> silahkan <a href="{{ url('login') }}" class="text-primary"
