                    ...
                    <ul id="sidebarnav">
                        <li>
                            <div class="user-profile d-flex no-block dropdown m-t-20">
                                <div class="user-pic"><img src="{{ url('assets/images/users/user-01.png') }}" alt="users" class="rounded-circle" width="40" /></div>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{ url('dashboard/siswa/histori') }}" aria-expanded="false">
                                <i class="mdi mdi-history"></i>
                                <span class="hide-menu">Histori Pembayaran Siswa</span>
                            </a>
                        </li>												              
                    </ul>
                </nav>
