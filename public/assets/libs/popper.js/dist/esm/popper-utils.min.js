...
function h(b) {
    ...
    for (
        var c = g(10) ? document.body : null, d = b.offsetParent;
...
function u(b, d) {
    ...
    f &&
        "HTML" === d.nodeName &&
        ((k.top = e(k.top, 0)), (k.left = e(k.left, 0)));
    var q = s({
        top: j.top - k.top - o,
    ...
    return (
        (h && !f ? d.contains(l) : d === l && "BODY" !== l.nodeName) &&
            (q = n(q, d)),
        q
    );
}
    ...
    if ("viewport" === f) h = v(i, g);
        ...
        if ("HTML" === j.nodeName && !w(i)) {
            var m = q(),
                n = m.height,
                o = m.width;
            (h.top += k.top - k.marginTop),
                (h.bottom = n + k.top),
                (h.left += k.left - k.marginLeft),
                (h.right = o + k.left);
        } else h = k;
    }
...
function Y(a, b, d, e) {
    ...
    g.addEventListener(b, d, { passive: !0 }),
        f || Y(c(g.parentNode), b, d, e),
        e.push(g);
}
function Z(a, b, d, e) {
    (d.updateBound = e),
        T(a).addEventListener("resize", d.updateBound, { passive: !0 });
    var f = c(a);
    return (
        Y(f, "scroll", d.updateBound, d.scrollParents),
        (d.scrollElement = f),
        (d.eventsEnabled = !0),
        d
    );
