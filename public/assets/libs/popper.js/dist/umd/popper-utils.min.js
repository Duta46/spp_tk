 ...
 */ (function (a, b) {
    ...
    function f(a) {
        ...
        for (
            var c = e(10) ? document.body : null, d = a.offsetParent;
    ...
    function o() {
        var a = document.body,
            ...
            c = e(10) && getComputedStyle(b);
        return { height: n("Height", a, b, c), width: n("Width", a, b, c) };
    }
    function p(a) {
    ...
    function r(a, c) {
        ...
        f &&
            "HTML" === c.nodeName &&
            ((j.top = R(j.top, 0)), (j.left = R(j.left, 0)));
        var r = p({
            top: i.top - j.top - n,
        ...
        return (
            (g && !f ? c.contains(k) : c === k && "BODY" !== k.nodeName) &&
                (r = l(r, c)),
            r
        );
    }
