                            ...
                            if (
                                ...
                                if (
                                    ...
                                    var o =
                                        ...
                                        s = gt.getTransitionDurationFromElement(
                                            this._element
                                        );
                                    $(this._element)
                                        .one(gt.TRANSITION_END, function () {
    ...
    var de = {
            ...
            modifiers: {
                ...
                hide: {
                    ...
                    fn: function (t) {
                        if (
                            !ae(t.instance.modifiers, "hide", "preventOverflow")
                        )
                            return t;
                ...
                computeStyle: {
                    ...
                    fn: function (t, e) {
                        ...
                        if (
                            ((p =
                                "bottom" === f ? -a.height + c.bottom : c.top),
        ...
        pe = (function () {
            function o(t, e) {
                ...
                Ht(this, o),
                    ...
                    Object.keys(
                        Ut({}, o.Defaults.modifiers, i.modifiers)
                    ).forEach(function (t) {
    ...
    var ge,
                ...
                return (
                    (t.toggle = function () {
                        if (
                            ...
                            if ((l._clearMenus(), !e)) {
                                ...
                                if (
                                    (ge(t).trigger(i), !i.isDefaultPrevented())
                                ) {
                                    if (!this._inNavbar) {
                    ...
                    (t._getPlacement = function () {
                        ...
                        return (
                            t.hasClass(Ie)
                                ? ((e = je),
                                  ge(this._menu).hasClass(Se) && (e = Re))
                                : t.hasClass(De)
                                ? (e = We)
                                : t.hasClass(Ae)
                                ? (e = Fe)
        ...
        Ti =
            ...
            (on = (function () {
                ...
                return (
                    ...
                    (t._getConfig = function (t) {
                        return (
                            (t = c({}, ze, t)), gt.typeCheckConfig(Qe, t, Xe), t
                        );
                    }),
                    ...
                    (t._setEscapeEvent = function () {
                        ...
                        this._isShown && this._config.keyboard
                            ...
                            : this._isShown ||
                              Ve(this._element).off(Je.KEYDOWN_DISMISS);
                    }),
                    ...
                    (t._resetScrollbar = function () {
                        Ve(rn.FIXED_CONTENT).each(function (t, e) {
                            ...
                            Ve(
                                rn.STICKY_CONTENT + ", " + rn.NAVBAR_TOGGLER
                            ).each(function (t, e) {
            ...
            (An = (function () {
                ...
                return (
                    ...
                    (t.getTipElement = function () {
                        return (
                            (this.tip =
                                this.tip || sn(this.config.template)[0]),
                            this.tip
                        );
                    }),
                    ...
                    (t._enter = function (t, e) {
                        ...
                        (e = e || sn(t.currentTarget).data(n)) ||
                            ...
                            t &&
                                (e._activeTrigger[
                                    "focusin" === t.type ? wn : Cn
                                ] = !0),
                            sn(e.getTipElement()).hasClass(yn) ||
                            e._hoverState === mn
                                ? (e._hoverState = mn)
        ...
        Ii =
            ...
            Kn(window).on(Xn.LOAD_DATA_API, function () {
                for (
                    var t = Kn.makeArray(Kn($n.DATA_SPY)), e = t.length;
                    e--;
